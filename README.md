# @farfarawaylabs/react-native-animatable-notifications

Highly customizable UI library to show animatable and highly customizable toast style notifications in React Native.

## Installation

This library has a few dependecies you need to install firts:
pubsub-js, react-native-animatable, react-native-vector-icons

```sh
yarn add @farfarawaylabs/react-native-animatable-notifications
```
